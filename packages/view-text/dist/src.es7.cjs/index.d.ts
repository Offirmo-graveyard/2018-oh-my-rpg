...
declare function render_armor(i: Armor, options?: RenderingOptions): string;
declare function render_weapon(i: Weapon, options?: RenderingOptions): string;
declare function render_item(i: Item | null, options?: RenderingOptions): string;
declare function render_monster(m: Monster, options?: RenderingOptions): string;
...
export { TextStyle, RenderingOptions, DEFAULT_RENDERING_OPTIONS, render_weapon, render_armor, render_item, render_monster, render_characteristics, render_equipment, render_inventory, render_wallet, render_adventure };
