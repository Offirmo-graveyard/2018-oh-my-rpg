import { CharacterStat, CharacterClass, Characteristics, State } from './types';
...
export { CharacterStat, CharacterClass, Characteristics, State, CHARACTER_STATS, factory, rename, switch_class, increase_stat };
