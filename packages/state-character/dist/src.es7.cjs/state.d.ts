...
export { CharacterAttribute, CharacterClass, CharacterAttributes, State, CHARACTER_STATS, CHARACTER_STATS_SORTED, CHARACTER_CLASSES, factory, rename, switch_class, increase_stat, DEMO_STATE, OLDEST_LEGACY_STATE_FOR_TESTS, MIGRATION_HINTS_FOR_TESTS };
